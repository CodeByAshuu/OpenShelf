  ...
  return (
    <div className="w-full bg-white pt-20">
      ...
      <div className="text-center mb-12 sm:mb-16 md:mb-20 px-4 sm:px-6 md:px-8">
        <div className="text-lg sm:text-xl md:text-2xl font-semibold font-mono tracking-tight text-[#12284C] mb-1">For More Info</div>
        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold font-serif tracking-wider text-[#12284C] uppercase" style={{ fontFamily: 'Georgia, serif' }}>CONTACT US</h1>
      </div>
